...
ps5m = mean(psx5data.exectime);
ps10m = mean(psx10data.exectime);
ps20m = mean(psx20data.exectime);
ps40m = mean(psx40data.exectime);
ps60m = mean(psx60data.exectime);

mexecdatas = [fd5m fd10m fd20m fd40m fd60m;...
    sfd5m sfd10m sfd20m sfd40m sfd60m;...
